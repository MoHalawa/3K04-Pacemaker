...
class Graph(tk.Frame):
    def __init__(self, reference,canv_h, canv_w):
        ...
        self.canv_h = canv_h
        self.canv_w = canv_w
        self.data = [[0, 200], [100, 400], [1000, 200], [4000, 200]]
    ...
    def draw(self):
        ...
        self.canv.create_line(self.x_off, self.y_off + self.y_line, self.x_off + self.x_line, self.y_off + self.y_line,
                              fill='#000000', width=2)
        self.canv.create_line(self.x_off, self.y_off, self.x_off, self.y_off + self.y_line, fill='#000000', width=2)
        create_ticks(canv=self.canv, rh=self.scale_hy, rl=self.scale_ly, x_off=self.x_off, y_off=self.y_off,
                     line=self.y_line, c_line=self.x_line,
                     ranges=ranges, a=acceptable_y, horz=False)
        create_ticks(canv=self.canv, rh=self.scale_hx, rl=self.scale_lx, x_off=self.x_off, y_off=self.y_off,
                     line=self.x_line, c_line=self.y_line,
                     ranges=ranges, a=acceptable_x, horz=True)
        self.plot()
